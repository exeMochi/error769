...
public class GuiMainMenu extends GuiScreen {
	...
	private void drawPanorama(int var1, int var2, float var3) {
		...
		for(int var6 = 0; var6 < var5 * var5; ++var6) {
			...
			for(int var10 = 0; var10 < 6; ++var10) {
				...
				GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/title/bg/panorama.png"));
	...
	public void drawScreen(int var1, int var2, float var3) {
		float alpha = (float)(Math.sin((double)(System.currentTimeMillis() % 1000L) / 1000.0 * Math.PI * 2.0) * 0.5 + 0.5f);
		this.renderSkybox(var1, var2, var3);
		new NoiseEffect().drawNoiseEffect(0, 0, this.mc.displayWidth, this.mc.displayHeight, 35.0F, 1.15F, 20);	
		Tessellator var4 = Tessellator.instance;
		short var5 = 274;
		...
		if((double)this.updateCounter < 1.0E-4D) {
			...
			this.drawTexturedModalRect(var6 + 155, var7 + 0, 0, 45, 155, 44);
			new NoiseEffect().drawNoiseEffect(var6 + 0, var7 + 0, (155 * 2) - 47, 44, 9.1F, 0.6F, 3);
		}
		...
		GL11.glPopMatrix();
		this.drawString(this.fontRenderer, "error769", 2, this.height - 10, 16777215);
